//modifications are marked with "mod here" ctrl+f to find
/*
...
//        display_environment(E);
        ...
        if (is_literal(command)) {
            ...
            //mod here
            C = pair(second_operand(command),
                 pair(first_operand(command),
...
//parse_and_evaluate('function foo(a,b){return display(a) - display(b);}foo(display(1),display(2));');
